...
update_sysctl() {
	...
	base_url="https://download.fastgit.org/hwdsl2/vpn-extras/releases/download/v1.0.0"
...
OpenVPN Script
https://hub.fastgit.xyz/hwdsl2/openvpn-install
EOF
}
...
LimitNPROC=infinity" > /etc/systemd/system/openvpn-server@server.service.d/disable-limitnproc.conf
	...
	# Get easy-rsa
	easy_rsa_url='https://download.fastgit.org/OpenVPN/easy-rsa/releases/download/v3.1.1/EasyRSA-3.1.1.tgz'
